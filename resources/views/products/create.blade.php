...
<div class="max-w-2xl mx-auto space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            ...
            <p class="text-sm text-slate-500 mt-0.5">Create a new item entry for the product catalog & price list.</p>
        </div>
        ...
        <form method="POST" action="{{ route('products.store') }}" class="space-y-5">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="text" name="product_code" value="{{ old('product_code', 'PRD-' . strtoupper(Str::random(6))) }}" required
            ...
            <div>
                ...
                <input type="text" name="name" value="{{ old('name') }}" placeholder="e.g. Michelin Pilot Street 2 (110/70-17)" required
            ...
            <div>
                ...
                <input type="text" name="category" list="category-list" value="{{ old('category') }}" placeholder="Select or type category..." required
            ...
            <div>
                ...
                <input type="number" name="unit_price" value="{{ old('unit_price') }}" step="500" min="0" placeholder="150000" required
